...
const Experts = () => {
  return (
    <section className="bg_black py-sm-5">
      <div className="Experts_back_img">
        <div className="container">
          <div className="py-5">
            ...
            <Row className="mt-4 pt-2">
              <Col md={2}></Col>
              <Col md={4} data-aos="flip-left" data-aos-duration="3000">
                <img className="w-100" src={brian} alt="brian" />
                <div className="d-flex justify-content-between mt-3">
                  <span>
                    <p className="fw_600 ff_Plus fs_md clr_white mb-0">
                      Brian A. Bakke, PhD
                    </p>
                    <p className="fw_400 ff_Roboto fs_xsm clr_white pt-2">
                      PhD Biochemistry
                    </p>
                  </span>
                  <span className="pointer">
                    <svg
                      className="Experts_hover"
                      width="32"
                      height="33"
                      viewBox="0 0 32 33"
                      fill="none"
              ...
              <Col md={4} data-aos="flip-right" data-aos-duration="2000">
                <img className="w-100" src={george} alt="george" />
                <div className="d-flex justify-content-between mt-3">
                  <span>
                    <p className="fw_600 ff_Plus fs_md clr_white mb-0">
                      George W. Rozakis Md
